          ...
          <td height="7" align="center" valign="top"><table width="600" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td bgcolor="#CCCCCC"><table width="600" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <tr>
                    <td height="26" align="center" bgcolor="#E4EBF1"><table width="439" border="0" cellpadding="0" cellspacing="0">
                      <tr align="left">
                  ...
                  <tr>
                    <td height="26" align="center" bgcolor="#E4EBF1"><table width="439" border="0" cellpadding="0" cellspacing="0">
                      <tr align="left">
                        <td width="73"><strong>자격증 </strong></td>
                        <td width="173"><strong>
                          <input name="textfield3325424" type="text" size="20">
                        </strong></td>
                        <td width="60"><strong>취득일</strong></td>
                        <td width="133"><strong> </strong><strong>
                          <input name="textfield33254223" type="text" size="20">
                        </strong></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <td height="26" align="center" bgcolor="#E4EBF1"><table width="439" border="0" cellpadding="0" cellspacing="0">
                      <tr align="left">
                        <td width="73"><strong>자격증 </strong></td>
                        <td width="173"><strong>
                          <input name="textfield3325426" type="text" size="20">
                        </strong></td>
                        <td width="60"><strong>취득일</strong></td>
                        <td width="133"><strong> </strong><strong>
                          <input name="textfield33254224" type="text" size="20">
                        </strong></td>
                      </tr>
                    </table></td>
                  </tr>
                    ...
                    <tr> 
                      <td height="26" align="center" bgcolor="#E4EBF1"><table width="600" border="0" cellpadding="0" cellspacing="0">
                        <tr align="left">
                          ...
                          <td width="241"><strong>
                            <input name="textfield33254262" type="text" size="30">
                          </strong></td>
